...
export const translations = {
    hu: {
        ...
        tools: {
            hub: {
                title: "Ingyenes Eszközök",
                subtitle: "Hasznos, mindennapi eszközök a CyberLabs fejlesztőtől.",
                qr: {
                    title: "QR Kód Generáló",
                    desc: "Készíts egyedi, gyors QR kódot bármilyen linkből vagy szövegből korlátlanul."
                },
                imageCompressor: {
                    title: "Képtömörítő",
                    desc: "Tömörítsd a képeidet gyorsan és biztonságosan, közvetlenül a böngésződben."
                }
            },
            qr: {
                title: "QR Kód Generáló",
            ...
            imageCompressor: {
                title: "Képtömörítő",
                subtitle: "Optimalizáld a képeidet veszteségmentesen vagy kisebb fájlmérettel",
                features: ["100% Ingyenes", "Adatbiztonság", "Korlátlan Használat"],
                upload: "Húzd ide a képeket vagy kattints a feltöltéshez",
                uploadSub: "JPEG, PNG, WebP • Max 50MB / kép",
                quality: "Minőség",
                format: "Formátum",
                download: "Letöltés",
                ...
                dimensions: "Méret",
                clear: "Törlés",
                privacy: "A képeid nem hagyják el a böngésződet",
                processing: "Feldolgozás...",
                noImages: "Még nincs feltöltött kép",
                ready: "Kész a tömörítésre",
                recompress: "Újra tömörítés",
                compress: "Tömörítés indítása"
            }
        }
    },
    en: {
        ...
        insights: {
            ...
            articles: [
                {
                    category: 'Tools',
                    title: 'Image Compressor – 100% free, secure, unlimited usage',
                    excerpt: 'Optimize your images losslessly or with smaller file sizes in just a few clicks. Secure web-based image compression, 100% free.',
                    read_more: "Read more"
                },
                {
                    category: 'Tools',
                    title: 'QR Code Generator – Free, unlimited, no watermarks, no ads',
                    excerpt: 'A QR code is a basic tool today: a fast bridge from the physical world to digital. Create your own watermark-free QR code completely free.',
                    read_more: "Read more"
                },
                {
        ...
        cookie: {
            text: "This website uses cookies to function properly.",
            more: "More info:",
            decline: "Decline",
            accept: "Accept"
        },
        ...
        tools: {
            hub: {
                title: "Free Tools",
                subtitle: "Useful, everyday tools developed by CyberLabs.",
                qr: {
                    title: "QR Code Generator",
                    desc: "Create custom, fast QR codes from any link or text without limits."
                },
                imageCompressor: {
                    title: "Image Compressor",
                    desc: "Compress your images quickly and securely, right in your browser."
                }
            },
            qr: {
                title: "QR Code Generator",
                subtitle: "Enter a link or text, and we'll generate the QR code instantly.",
                placeholder: "https://cyberlabsweb.com",
                download: "Download",
                empty: "Your code will appear here...",
                features: ["100% Free", "No Watermark", "Unlimited Use"]
            },
            imageCompressor: {
                title: "Image Compressor",
                subtitle: "Optimize your images losslessly or with smaller file sizes",
                features: ["100% Free", "Data Security", "Unlimited Use"],
                upload: "Drag & drop images here or click to upload",
                uploadSub: "JPEG, PNG, WebP • Max 50MB / image",
                quality: "Quality",
                format: "Format",
                download: "Download",
