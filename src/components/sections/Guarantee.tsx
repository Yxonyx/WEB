    ...
    return (
        <section className="py-24 px-4 relative overflow-hidden">
            ...
            <div className="max-w-4xl mx-auto">
                <div className="relative overflow-hidden rounded-3xl bg-white/5 p-8 md:p-12 border border-white/10 shadow-2xl text-center group hover:border-white/20 transition-colors duration-500">
