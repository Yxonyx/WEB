...
export const Footer = () => {
    ...
    return (
        <footer className="relative pt-16 pb-10 overflow-hidden">
            ...
            />
            <div className="pointer-events-none absolute inset-0 bg-[#2DA8EA]/24" />
            <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,rgba(255,255,255,0.18)_0%,rgba(255,255,255,0.08)_45%,rgba(27,126,213,0.18)_100%)]" />
            ...
            <div className="pointer-events-none absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-[#2DA8EA] to-transparent" />
            <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_0%,rgba(255,255,255,0.28),transparent_60%)]" />
            <div className="pointer-events-none absolute -top-40 left-1/2 -translate-x-1/2 w-[80%] h-[300px] rounded-[50%] bg-[radial-gradient(ellipse_at_center,rgba(255,214,106,0.20),transparent_60%)] blur-2xl" />

            <Container className="relative z-10">
                {/* Top row: brand + tagline + socials */}
                <div className="flex flex-col items-center text-center mb-10">
                    <div className="flex items-center gap-3 mb-3">
                        <span className="text-xl font-hero font-bold tracking-tight leading-none flex items-baseline drop-shadow-[0_3px_12px_rgba(0,82,166,0.28)]">
                    ...
                    <p className="text-sm text-white/82 max-w-md mb-6">
                    ...
                    <div className="flex items-center justify-center gap-2.5">
                        {socialLinks.map((social, i) => (
                            <a
                                ...
                                className="group w-10 h-10 flex items-center justify-center rounded-full border border-white/30 bg-white/[0.14] hover:bg-white/[0.22] hover:border-white/60 hover:-translate-y-0.5 transition-all duration-300"
                            >
                                <social.icon className="w-[18px] h-[18px] text-white/80 group-hover:text-white transition-colors duration-300" />
                            </a>
                        ))}
                    </div>
                </div>
                ...
                <div className="flex flex-wrap items-center justify-center gap-3 mb-10">
                    <Link
                        ...
                        className="group inline-flex items-center gap-2 px-4 py-2 rounded-full border border-white/30 bg-white/[0.14] hover:bg-white/[0.22] hover:border-white/60 text-white/82 hover:text-white transition-all duration-300"
                    >
                ...
                <div className="relative mb-8">
                    ...
                    <div className="relative flex justify-center">
                        <span className="px-4 text-[10px] font-mono uppercase tracking-[0.3em] text-white/82 bg-white/[0.12] backdrop-blur-sm rounded-full py-1 border border-white/20">
                            Kapcsolat
                        </span>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-8 mb-10 text-center">
                    <span className="text-sm text-white/82">{t('footer.call')}</span>
                    <a
                ...
                {/* Bottom row */}
                <div className="pt-6 border-t border-white/[0.18] flex flex-col sm:flex-row items-center justify-between gap-4 text-sm">
