            ...
            <Container>
                <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-start">
                    ...
                    <div className="lg:col-span-5">
                        ...
                        <div className="p-6 rounded-2xl bg-[#0B1024] border border-white/15 shadow-2xl">
                    ...
                    <div className="lg:col-span-7">
                        <motion.div
                            className="relative pl-12 sm:pl-10 space-y-12"
                            initial="hidden"
                            whileInView="visible"
                        ...
                        >
                            ...
                            <div className="absolute left-[27px] sm:left-[9px] top-5 bottom-28 w-[2px] bg-gradient-to-b from-neonBlue via-accent1 via-60% to-neonPurple/50" />
                            ...
                            {steps.map((step, i) => {
                                ...
                                return (
                                    ...
                                    >
                                        {/* Number Node */}
                                        <div className={`absolute -left-[48px] sm:-left-[50px] w-10 h-10 rounded-full border-[3px] flex items-center justify-center z-10 transition-all duration-300 ${step.highlight
