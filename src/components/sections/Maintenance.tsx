            ...
            <Container>
                ...
                >
                    ...
                    <motion.div variants={itemVariants} className="order-1 lg:order-2">
                        ...
                        <h2 className="text-2xl sm:text-3xl lg:text-[2.5rem] font-bold font-display text-white mb-6 leading-tight">{t('maintenance_sec.content.title').split(' ').slice(0, -1).join(' ')} <span className="text-transparent bg-clip-text bg-accent-gradient-reverse">{t('maintenance_sec.content.title').split(' ').slice(-1)}</span></h2>
